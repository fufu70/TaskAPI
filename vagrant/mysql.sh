...
sudo mysql --user="root" --password=$DEFAULT_PASSWORD < $SHELL_HOME/sql/task_api.sql
sudo mysql --user="root" --password=$DEFAULT_PASSWORD < $SHELL_HOME/sql/task_api_test.sql
